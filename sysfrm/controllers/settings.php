...
<script type="text/javascript" src="' . $_theme . '/lib/ui-settings.js"></script>
');
...
');
        ...
        foreach ($pls as $pl){
            ...
            $i = 0;
            if(file_exists($pl_path.'/meta.php')){
                $i++;
                //
                ...
                $plugin = null;
                require($pl_path.'/meta.php');
                $pl_html .= ' <tr>

                <td class="project-title">
                    <a href="#" class="cedit">'.$plugin['name'].'</a>
                    <br>
